...
export function HeroSection() {
  ...
  const { title, description, navigation } = content.pages.index;
        ...
        <nav className="flex items-center justify-between" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">{siteConfig.appName}</span>
              <img
                className="h-8 rounded-full shadow-xl"
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
          ...
          <div className="mt-10 flex items-center gap-x-6">
            ...
            <Link
              href={buttons.learnmore.href}
              className="text-sm font-semibold leading-6 text-gray-900"
            >
              {buttons.learnmore.name} <span aria-hidden="true">→</span>
            </Link>
          </div>
        </div>
